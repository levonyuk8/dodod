...
export class Step3Component implements OnInit {
  ...
  fillingOptionList = {
    ...
    options: [
      {
        imgUrl: 'url(/img/svg/s3/1_.svg)', value: 1,
      },
      {
        imgUrl: 'url(/img/svg/s3/2_.svg)', value: 2,
      },
      {
        imgUrl: 'url(/img/svg/s3/3_.svg)', value: 3,
      },
      {
        imgUrl: 'url(/img/svg/s3/4_.svg)', value: 4,
      },
      {
        imgUrl: 'url(/img/svg/s3/5_.svg)', value: 5,
      },
      {
      ...
      {
        imgUrl: 'url(/img/svg/s3/10_.svg)', value: 10,
      },
      {
        imgUrl: 'url(/img/svg/s3/11_.svg)', value: 11,
      },
      {
        imgUrl: 'url(/img/svg/s3/12_.svg)', value: 12,
      },
      {
        imgUrl: 'url(/img/svg/s3/13_.svg)', value: 13,
      },
      {
        imgUrl: 'url(/img/svg/s3/14_.svg)', value: 14,
      },
    ]
  }
  ...
  private createAndSaveSectionByWardrobeScheme() {
    ...
    sectionByDoors.forEach((section, index) => {
      ...
      const filling = {
        ...
        fillingOption: 1,
        sectionWithVY: scheme ? scheme.SR_yaschiki_vneshnie_kol : 0,
      }
  ...
  ngOnInit(): void {
    ...
    this.section$.pipe(
      ...
      tap(data => {
        ...
        const nextSection = filingList.find((item: any) => {
