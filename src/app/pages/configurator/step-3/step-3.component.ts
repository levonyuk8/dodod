...
export class Step3Component implements OnInit {
  ...
  fillingOptions = {
    ...
    options: [
      {
        imgUrl: 'url(/img/svg/s3/1.svg)', label: '', value: 1,
      },
      {
        imgUrl: 'url(/img/svg/s3/2.svg)', label: '', value: 2,
      },
      {
        imgUrl: 'url(/img/svg/s3/3.svg)', label: '', value: 3,
      },
      {
        imgUrl: 'url(/img/svg/s3/4.svg)', label: '', value: 4,
      },
      {
        imgUrl: 'url(/img/svg/s3/5.svg)', label: '', value: 5,
      },
      {
        imgUrl: 'url(/img/svg/s3/6.svg)', label: '', value: 6,
      },
      {
        imgUrl: 'url(/img/svg/s3/7.svg)', label: '', value: 7,
      },
      {
        imgUrl: 'url(/img/svg/s3/8.svg)', label: '', value: 8,
      },
      {
        imgUrl: 'url(/img/svg/s3/9.svg)', label: '', value: 9,
      },
      {
        imgUrl: 'url(/img/svg/s3/10.svg)', label: '', value: 10,
      },
      {
        imgUrl: 'url(/img/svg/s3/11.svg)', label: '', value: 11,
      },
      {
        imgUrl: 'url(/img/svg/s3/12.svg)', label: '', value: 12,
      },
    ]
  }
  ...
  private createAndPatchForm() {
    return this.stepThreeForm = this.fb.group({
      ...
      fillingOptions: new FormControl<number>(0),
      NumberShelvesInMainSection: new FormControl<number>(0),
      NumberShelvesTop: new FormControl<number>(0),
      NumberShelvesMezzanine: new FormControl<number>(0),
    })
  }
